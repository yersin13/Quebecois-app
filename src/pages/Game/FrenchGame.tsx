...
const FrenchGame: React.FC = () => {
  ...
  const [currentQuestion, setCurrentQuestion] = useState(Math.floor(Math.random() * questionsFrench.length));
...
setIcon1(true)
  ...
  const answer1 = questionsFrench[currentQuestion].answerOptions[0].answerText1
  const answer2 = questionsFrench[currentQuestion].answerOptions[1].answerText2
  const answer3 = questionsFrench[currentQuestion].answerOptions[2].answerText3
  const answer4 = questionsFrench[currentQuestion].answerOptions[3].answerText4
  ...
  {icon1 ? (light1 ? <IonIcon className="icons-answers-fail" icon={skullOutline} /> : <IonIcon className="icons-answers-win" icon={checkmarkCircleOutline} />) : ""}
   ...
   {icon5 ? (light5 ? <IonIcon className="icons-answers-fail" icon={skullOutline} /> : <IonIcon className="icons-answers-win" icon={checkmarkCircleOutline} />) : ""}
                    ...
                    <IonItem lines="none" >
                      <h6 className='question-text question-title'>Qu’est que ça veut dire ?</h6>
                    </IonItem>

                    <IonItem lines="none">
                      <h3 className='question-title'>{questionsFrench[currentQuestion].questionText}</h3>
                    </IonItem>
                    <IonItem lines="none">
                      <div>
                        <p className="example">Example:</p>
                        <p className="example">{questionsFrench[currentQuestion].example}</p>
                      </div>
                    </IonItem>
                  ...
                  <div className='answer-section'>
                    ...
                    <IonCard className="card">
                      <IonItem lines='none' button className="item-answer"
                        onClick={(e) => handleAnswerOptionClick1(questionsFrench[currentQuestion].answerOptions[0].isCorrect, answer1)}
                    ...
                    <IonCard className="card">
                      <IonItem lines='none' button className="item-answer"
                        onClick={(e) => handleAnswerOptionClick2(questionsFrench[currentQuestion].answerOptions[1].isCorrect, answer2)}
                    ...
                    <IonCard className="card">
                      <IonItem lines='none' button className="item-answer"
                        onClick={(e) => handleAnswerOptionClick3(questionsFrench[currentQuestion].answerOptions[2].isCorrect, answer3)}
                    ...
                    <IonCard className="card">
                      <IonItem lines='none' button className="item-answer"
                        onClick={(e) => handleAnswerOptionClick4(questionsFrench[currentQuestion].answerOptions[3].isCorrect, answer4)}
