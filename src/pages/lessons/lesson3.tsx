...
import { facts, lesson1, lesson2, lesson3 } from '../../data-lessons';
        ...
        <IonList>
          ...
          <div>
            <div className=''>
              ...
              <h1 className={color? 'lesson-main-title text-dark ': 'lesson-main-title text-white '}>Family Vocabulary</h1>
            ...
            <IonItem lines='none'>
              <p className={color? ' text-dark ': ' text-white '}>Here you can find some vocabulary Quebecois that are Family related.</p>
            </IonItem>
